...
class AppointmentController extends Controller
{
    ...
    {
        $appointments = $this->appointmentService->getUpcomingClinicAppointments($this->clinicId);
        // dd($appointments);
    ...
    public function show(Request $request)
    {
        ...
        return view('staff.view_appointment', compact('appointment', 'medicines', 'laboratoryTests', 'historicalAppointments', 'appointmentCount'));
    }
