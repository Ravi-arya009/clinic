...
class UpdateDependantRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'dependant_phone' => 'required|digits_between:10,13|unique:dependants,phone,' . $this->dependent_id,
            'dependant_whatsapp' => 'digits_between:10,13|unique:dependants,whatsapp,' . $this->dependent_id,
