...
<head>
    {{-- can create a yeild section in head for static seo contents such as meta titles --}}
    {{-- update: won't need above solution because panel pages aren't going to be indexed, instead make something universal and/or remove seo related tags --}}
    <meta charset="utf-8">
...
<body>
    ...
    <div class="main-wrapper">
        @include('global.partials.header') <!-- Including Header -->
        <!-- Breadcrumb -->
                ...
                <div class="row align-items-center inner-banner">
                    <div class="col-md-12 col-12 text-center">
                        ...
                        <nav aria-label="breadcrumb" class="page-breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">@yield('breadcrum-link-one', 'Home')</a></li>
        ...
        <!-- /Page Content -->
        @include('global.partials.footer') <!-- Including Footer -->
    </div>
    <!-- /Main Wrapper -->
