...
<div class="prescribe-download">
    ...
    <ul>
        ...
        {{-- <li><a href="{{ route('prescription.download',['appointment'=> $appointment])}}" class="btn btn-primary prime-btn">Download</a></li> --}}
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="invoice-info">
                    ...
                    <h6 class="customer-text">{{ $appointment->doctor->doctorProfile->qualification->name }}</h6>
