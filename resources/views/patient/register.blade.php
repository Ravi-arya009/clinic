                        ...
                        <div class="account-content">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-md-7 col-lg-6 login-left">
                                    <img src={{ asset('img/login-banner.png') }} class="img-fluid" alt="Login Banner">
                                </div>
                                <div class="col-md-12 col-lg-6 login-right">
                                    ...
                                    <form action="{{route('patient.store')}}" method="POST">
                                        ...
                                        <div class="mb-3 form-focus">
                                            <input type="text" class="form-control floating" name="name" id="name" value="{{ old('name') }}" required>
                                            <label class="focus-label">Name</label>
                                        </div>
                                        <div class="mb-3 form-focus">
                                            <input type="phone" class="form-control floating" name="phone" id="phone" value="{{ old('phone') }}" required>
                                        ...
                                        <div class="mb-3 form-focus">
                                            <input type="password" class="form-control floating" name="password_confirmation" id="password_confirmation" required>
