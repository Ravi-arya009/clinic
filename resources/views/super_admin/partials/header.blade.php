                    ...
                    <li class="nav-item dropdown has-arrow logged-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <div class="user-header">
                                ...
                                <div class="user-text">
                                    <h6>{{ auth()->guard('super_admin')->user()->name }}</h6>
                                    <p class="text-success mb-0">Super Admin</p>
                                </div>
                            </div>
                            <a class="dropdown-item" href="{{ route('super_admin.dashboard') }}">Dashboard</a>
                            <a class="dropdown-item" href="#">Profile Settings</a>
                            <a class="dropdown-item" href="{{ route('super_admin.logout') }}">Logout</a>
                        </div>
                    </li>
                    <!-- /User Menu -->
                </ul>
