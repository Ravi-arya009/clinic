...
@section('content')
    ...
    <table class="my-datatable table-hover" id="state-master-table">
        ...
        @foreach ($states as $state)
            <tr class="table-appointment-wrap" id="state-row-{{ $state->id }}">
                ...
                <td class="mail-info-patient" id="state-name-{{ $state->id }}">
                    <ul>
                        <li>{{ isset($state->name) ? ucfirst($state->name) : 'N/A' }}</li>
                    </ul>
                </td>
                ...
                <td class="appointment-start">
                    <a href="javascript:void(0);" class="delete-state" data-bs-toggle="modal" data-bs-target="#delete_state_modal" data-state-id="{{ $state->id }}">Delete</a>
                </td>

                <td class="appointment-start">
                    <a href="#edit_state" class="edit-state-button start-link" data-bs-toggle="modal" title="Edit State" data-state-id="{{ $state->id }}" data-state-name="{{ $state->name }}">
                        Edit
                    </a>
                </td>
            </tr>
