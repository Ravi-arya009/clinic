					...
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="banner-content aos" data-aos="fade-up">
								<h1>Welcome to <span>{{$clinicName}}</span></h1>
								<img src={{asset('img/icons/header-icon.svg')}} class="header-icon" alt="header-icon">
								<p>Embark on your healing journey with Doccure</p>
								<a href="booking.html" class="btn">Start a Consult</a>
								<div class="banner-arrow-img">
									<img src={{asset('img/down-arrow-img.png')}} class="img-fluid" alt="down-arrow">
								</div>
							</div>
						...
						<div class="col-lg-6">
							<div class="banner-img aos" data-aos="fade-up">
								<img src={{asset('img/banner-img.png')}} class="img-fluid" alt="patient-image">
								<div class="banner-img1">
									<img src={{asset('img/banner/banner-img1.svg')}} class="img-fluid" alt="checkup-image">
								</div>
								<div class="banner-img2">
									<img src={{asset('img/banner/banner-img2.svg')}} class="img-fluid" alt="doctor-slide">
								</div>
								<div class="banner-img3">
									<img src={{asset('img/banner/banner-img3.svg')}} class="img-fluid" alt="doctors-list">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="container">
					...
					<div class="owl-carousel specialities-slider-one owl-theme aos" data-aos="fade-up">
						<div class="item">
							<div class="specialities-item">
								<div class="specialities-img">
									<span><img src={{asset('img/specialities/specialities-01.svg')}} alt="heart-image"></span>
								</div>
								<p>Cardiology</p>
							</div>
						</div>
						<div class="item">
							<div class="specialities-item">
								<div class="specialities-img">
									<span><img src={{asset('img/specialities/specialities-02.svg')}} alt="brain-image"></span>
								</div>
								<p>Neurology</p>
							</div>
						</div>
						<div class="item">
							<div class="specialities-item">
								<div class="specialities-img">
									<span><img src={{asset('img/specialities/specialities-03.svg')}} alt="kidney-image"></span>
								</div>
								<p>Urology</p>
							</div>
						</div>
						<div class="item">
							<div class="specialities-item">
								<div class="specialities-img">
									<span><img src={{asset('img/specialities/specialities-04.svg')}} alt="bone-image"></span>
								</div>
								<p>Orthopedic</p>
							</div>
						</div>
						<div class="item">
							<div class="specialities-item">
								<div class="specialities-img">
									<span><img src={{asset('img/specialities/specialities-05.svg')}} alt="dentist"></span>
								</div>
								<p>Dentist</p>
							</div>
						</div>
						<div class="item">
							<div class="specialities-item">
								<div class="specialities-img">
									<span><img src={{asset('img/specialities/specialities-06.svg')}} alt="eye-image"></span>
								</div>
								<p>Ophthalmology</p>
							</div>
						</div>
								...
								<div class="doc-pro-img">
									<a href="doctor-profile.html">
										<div class="doctor-profile-img">
											<img src={{asset('img/doctors/doctor-03.jpg')}} class="img-fluid" alt="Ruby Perrin">
										</div>
									</a>
						...
						<div class="item">
							<div class="doctor-profile-widget doc-item">
								<div class="doc-pro-img">
									<a href="doctor-profile.html">
										<div class="doctor-profile-img">
											<img src={{asset('img/doctors/doctor-02.jpg')}} class="img-fluid" alt="Paul Richard">
										</div>
									</a>
									<div class="doctor-amount">
										<span>$300</span>
						...
						<div class="item">
							<div class="doctor-profile-widget doc-item">
								<div class="doc-pro-img">
									<a href="doctor-profile.html">
										<div class="doctor-profile-img">
											<img src={{asset('img/doctors/doctor-04.jpg')}} class="img-fluid" alt="Darren Elder">
										</div>
									</a>
									<div class="doctor-amount">
										<span>$100</span>
						...
						<div class="item">
							<div class="doctor-profile-widget doc-item">
								<div class="doc-pro-img">
									<a href="doctor-profile.html">
										<div class="doctor-profile-img">
											<img src={{asset('img/doctors/doctor-05.jpg')}} class="img-fluid" alt="Sofia Brient">
										</div>
									</a>
									<div class="doctor-amount">
										<span>$250</span>
						...
						<div class="item">
							<div class="doctor-profile-widget doc-item">
								<div class="doc-pro-img">
									<a href="doctor-profile.html">
										<div class="doctor-profile-img">
											<img src={{asset('img/doctors/doctor-01.jpg')}} class="img-fluid" alt="John Doe">
										</div>
									</a>
									<div class="doctor-amount">
										<span>$880</span>
									...
									<div class="pricing-header">
										<div class="pricing-header-info">
											<div class="pricing-icon">
												<span>
													<img src={{asset('img/icons/price-icon1.svg')}} alt="icon">
												</span>
											</div>
								...
								<div class="card-body">
									<div class="pricing-header">
										<div class="pricing-header-info">
											<div class="pricing-icon">
												<span>
													<img src={{asset('img/icons/price-icon2.svg')}} alt="icon">
												</span>
											</div>
											<div class="pricing-title">
												<h4>Pro</h4>
								...
								<div class="card-body">
									<div class="pricing-header">
										<div class="pricing-header-info">
											<div class="pricing-icon">
												<span>
													<img src={{asset('img/icons/price-icon3.svg')}} alt="icon">
												</span>
											</div>
											<div class="pricing-title">
												<h4>Enterprise</h4>
							...
							<div class="col-lg-3 col-md-4">
								<div class="footer-widget footer-about">
									<div class="footer-logo">
										<a href="index.html"><img src={{asset('img/logo-01.svg')}} alt="logo"></a>
									</div>
