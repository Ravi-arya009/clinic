													...
													<tbody>
															...
															<td>
																<div class="patient-info-profile">
																	<a href="appointments.html" class="table-avatar">
																		<img src={{asset('img/doctors-dashboard/profile-01.jpg')}} alt="Img">
																	</a>
														...
														<tr>
															<td>
																<div class="patient-info-profile">
																	<a href="appointments.html" class="table-avatar">
																		<img src={{asset('img/doctors-dashboard/profile-02.jpg')}} alt="Img">
																	</a>
																	<div class="patient-name-info">
																		<span>#Apt0002</span>
														...
														<tr>
															<td>
																<div class="patient-info-profile">
																	<a href="appointments.html" class="table-avatar">
																		<img src={{asset('img/doctors-dashboard/profile-03.jpg')}} alt="Img">
																	</a>
																	<div class="patient-name-info">
																		<span>#Apt0003</span>
														...
														<tr>
															<td>
																<div class="patient-info-profile">
																	<a href="appointments.html" class="table-avatar">
																		<img src={{asset('img/doctors-dashboard/profile-04.jpg')}} alt="Img">
																	</a>
																	<div class="patient-name-info">
																		<span>#Apt0004</span>
														...
														<tr>
															<td>
																<div class="patient-info-profile">
																	<a href="appointments.html" class="table-avatar">
																		<img src={{asset('img/doctors-dashboard/profile-05.jpg')}} alt="Img">
																	</a>
																	<div class="patient-name-info">
																		<span>#Apt0005</span>
										...
										<div class="upcoming-appointment-card">
											...
											<div class="upcoming-patient-info">
												<div class="info-details">
													<span class="img-avatar"><img src={{asset('img/doctors-dashboard/profile-01.jpg')}} alt="Img"></span>
													<div class="name-info">
														<span>#Apt0001</span>
												...
												<div class="circle-bg">
													<img src={{asset('img/bg/dashboard-circle-bg.png')}} alt="Img">
												</div>
											</div>
										...
										<div class="dashboard-card-body">
												...
												<div class="clinic-head">
													<div class="clinic-info">
														<span class="clinic-img">
															<img src={{asset('img/doctors-dashboard/clinic-02.jpg')}} alt="Img">
														</span>
														<h6>Sofi’s Clinic</h6>
													</div>
											...
											<div class="clinic-available mb-0">
												<div class="clinic-head">
													<div class="clinic-info">
														<span class="clinic-img">
															<img src={{asset('img/doctors-dashboard/clinic-01.jpg')}} alt="Img">
														</span>
							...
							<div class="col-xl-4 col-lg-6 col-md-8">
								<div class="footer-links">
									...
									<div class="app-store-links">
										<a href="javascript:void(0);"><img src={{asset('img/icons/app-store.svg')}} alt="Img"></a>
										<a href="javascript:void(0);"><img src={{asset('img/icons/google-play.svg')}} alt="Img"></a>
									</div>
								</div>
							</div>
						</div>
								...
								<ul class="payment-methods d-flex align-items-center">
									<li>
										<a href="javascript:void(0);">
											<img src={{asset('img/icons/payment-icon-01.svg')}} alt="Img">
										</a>
									</li>
									<li>
										<a href="javascript:void(0);">
											<img src={{asset('img/icons/payment-icon-02.svg')}} alt="Img">
										</a>
									</li>
									<li>
										<a href="javascript:void(0);">
											<img src={{asset('img/icons/payment-icon-03.svg')}} alt="Img">
										</a>
									</li>
									<li>
										<a href="javascript:void(0);">
											<img src={{asset('img/icons/payment-icon-04.svg')}} alt="Img">
										</a>
									</li>
								</ul>
							</div>
