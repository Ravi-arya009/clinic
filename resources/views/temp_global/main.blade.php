...
<body>
    ...
    <div class="main-wrapper">
        ...
        <!-- Header -->
        @include('temp_global.partials.header')
            ...
            <div class="container">
                <div class="row align-items-center inner-banner">
                    <div class="col-md-12 col-12 text-center">
                        <h2 class="breadcrumb-title">@yield('breadcrum-title', 'Staff')</h2>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-xl-3 theiaStickySidebar">
                        ...
                        <!-- Profile Sidebar -->
                        @include('temp_global.partials.sidebar')
                        <!-- /Profile Sidebar -->
        ...
        <!-- Footer Section -->
        @include('temp_global.partials.footer')
        <!-- /Footer Section -->
