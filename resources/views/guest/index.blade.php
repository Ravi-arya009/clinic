...
<body>
    ...
    <div class="main-wrapper home-one">
                    ...
                    <div class="search-box">
                        <form action="search.html">
                            ...
                            <div class="mb-3 search-info aos" data-aos="fade-up">
                                <input type="text" id="search" class="form-control" placeholder="Search Doctors, Clinics, Hospitals, Diseases Etc">
        ...
        <!-- Best Clinic Section -->
        <section class="our-doctors-section doctors-section specialities-section-one my-dark-background">
            <div class="container">
                <div class="row">
        ...
        <!-- Best Doctor Section -->
        <section class="our-doctors-section specialities-section-one">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 aos" data-aos="fade-up">
                        <div class="section-heading">
